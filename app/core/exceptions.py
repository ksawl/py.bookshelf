...
def validation_http_error(message: str, details: Optional[Dict[str, Any]] = None) -> HTTPException:
...
def internal_server_http_error(message: str, details: Optional[Dict[str, Any]] = None) -> HTTPException:
